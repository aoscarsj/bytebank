...
public class TesteOrdenacao {
	...
	public static void main(String[] args) {
		...
		lista.sort(null); // pois tem ordem natural, mas eh ma pratica, mas eh como eh implementado!
		
		//antigamente era feito assim \/
		//Collections.sort(lista); // pois lista tem Ordem Natural
		//Collections.sort(lista, new TitularDaContaComparator());
		//Collections.reverse(lista); //ordena pelo maior
